...
| 2 | **GitLab — Intermediate Backend, Database Change Management** | No numeric floor. Intermediate + Rails/Postgres (Postgres scale is a skill stretch, not a 3-year bar) | Bangalore (remote-first) | [Greenhouse](https://job-boards.greenhouse.io/gitlab/jobs/8722304002) | `Atul_Banyal_Resume_GitLab_Database.pdf` | `Atul_Banyal_Cover_GitLab_Database.pdf` |
| 3 | **Groww — SDE-I** | No years listed. Title is **SDE-I** | Bengaluru-VTP | [Greenhouse](https://job-boards.eu.greenhouse.io/growwreferrals/jobs/4953090101) | `Atul_Banyal_Resume_Groww.pdf` | `Atul_Banyal_Cover_Groww.pdf` |
| 4 | **Amazon — SDE I, FinOps FP&A** | **1+ years** non-internship professional SWE | Bengaluru | [amazon.jobs](https://www.amazon.jobs/en/jobs/10432823/software-development-engineer-i-finops-fp-a) | `Atul_Banyal_Resume_Amazon_FinOps.pdf` | `Atul_Banyal_Cover_Amazon_FinOps.pdf` |
| 5 | **Accenture — Custom SWE, Node.js** | Header **Experience: 2–5 years**. Body does **not** say min 3 years Node | Bengaluru | [Accenture](https://www.accenture.com/in-en/careers/jobdetails?id=ATCI-R1-S1891558_en) | `Atul_Banyal_Resume_Accenture.pdf` | `Atul_Banyal_Cover_Accenture.pdf` |
| 6 | **JumpCloud — Full Stack SWE, Front-End Focus** | **2 to 4 years** | Bangalore, remote-first (India) | [Lever](https://jobs.lever.co/jumpcloud/4ebbdea9-39c2-465d-bbdf-bf379a8e4a06) | `Atul_Banyal_Resume_JumpCloud_Fullstack.pdf` | `Atul_Banyal_Cover_JumpCloud_Fullstack.pdf` |
| 7 | **Amazon — SDE I, Amazon Payments** | **1+ years** | Hyderabad | [amazon.jobs](https://www.amazon.jobs/en/jobs/10530940/software-development-engineer-i-amazon-payments) | `Atul_Banyal_Resume_Amazon_Payments.pdf` | `Atul_Banyal_Cover_Amazon_Payments.pdf` |
| 8 | **Amazon — SDE I, IESP Merchant Tech** | **1+ years** | Bengaluru | [amazon.jobs](https://www.amazon.jobs/en/jobs/10511883/software-development-engineer-i-iesp-merchant-tech) | `Atul_Banyal_Resume_Amazon_SDE.pdf` | `Atul_Banyal_Cover_Amazon_SDE.pdf` |
...
# Do not apply — posted bar is 3+ years (PDFs exist; skip them)

| Role | Posted YOE (verbatim) | Why skip | Link |
|------|----------------------|----------|------|
| JumpCloud LDAP SWE | **3–5 years** of professional software development | 2y2m is below the floor | [Lever](https://jobs.lever.co/jumpcloud/756b176a-817b-4088-8eda-af8fbb389f9a) |
| Okta SWE, Professional Services R&D | **3+ years** of professional software development | 2y2m is below the floor | [Okta](https://www.okta.com/company/careers/opportunity/8056119?gh_jid=8056119) |
| Accenture Custom SWE Node.js ATCI-5218598-S1915173 | Header says 2–5, but body: **Minimum 3 year(s)** and **minimum 3 years of experience in Node.js** | Floor is 3, not 2 | [Accenture](https://www.accenture.com/in-en/careers/jobdetails?id=ATCI-5218598-S1915173_en) |
| GitLab Senior Backend 8736862002 | Senior (mentors intermediate engineers); not an Intermediate req | Wrong level | [Greenhouse](https://job-boards.greenhouse.io/gitlab/jobs/8736862002) |
| Amazon SDE, Alexa For Shopping 10478388 | **3+ years** non-internship professional SWE | Bengaluru but 3+ floor | [amazon.jobs](https://www.amazon.jobs/en/jobs/10478388/sde-alexa-for-shopping) |
| JumpCloud Devices SWE | **3 to 5 years** professional production | Also Go/OS-heavy | [Lever](https://jobs.lever.co/jumpcloud/1843b144-b17f-4b51-b569-f3e3d5597ba9) |

## 6. JumpCloud — Full Stack, Front-End Focus (keep)

- **JD:** **2 to 4 years**; Vue 3 / TypeScript UI + Node, Mongo, REST, K8s, AWS, Cursor; remote India.  
- **Your match:** 2y2m sits inside 2–4. React/Next production UI + Node/Express personal stack. **Vue is a ramp**, not production.  
...
- **ID:** 8722304002  
- **Posted YOE:** No numeric years. Intermediate.  
- **JD:** Rails + PostgreSQL, safe migrations, GitLab upgrade path.  
...
- **ID:** 4953090101  
- **Posted YOE:** None. Title is **SDE-I** (not SDE-II).  
...
- **ID:** 10432823  
- **Posted YOE:** **1+ years** of non-internship professional software development.  
- **Team:** Payments platform, AWS, GenAI on financial data.  
- **Your match:** 2y2m + payments/trading APIs, Docker/K8s, AWS, Cursor.  
- **Cover PDF:** `cover-letters/pdf/Atul_Banyal_Cover_Amazon_FinOps.pdf`

## 5. Accenture — Custom SWE Node.js

- **Req:** ATCI-R1-S1891558  
- **Posted YOE:** Header **Experience: 2–5 years**. Body does not add a 3-year Node minimum (unlike ATCI-5218598).  
- **JD:** Node.js, REST, SQL/NoSQL, Docker, optional K8s.  
- **Cover PDF:** `cover-letters/pdf/Atul_Banyal_Cover_Accenture.pdf`

## 7. Amazon — SDE I Payments (Hyderabad)

- **ID:** 10530940  
- **Posted YOE:** **1+ years**. Same Amazon account as #4.  
- **Cover PDF:** `cover-letters/pdf/Atul_Banyal_Cover_Amazon_Payments.pdf`

## 8. Amazon — SDE I Merchant Tech (Bengaluru)

- **ID:** 10511883  
- **Posted YOE:** **1+ years**. Same Amazon account as #4.  
- **Cover PDF:** `cover-letters/pdf/Atul_Banyal_Cover_Amazon_SDE.pdf`
...
| What | Why |
|------|-----|
| JPMorgan Chase | You asked to drop it |
| JumpCloud LDAP / Okta / Accenture ATCI-5218598 / GitLab Senior | Posted **3+ years** or Senior — see table above |
| Amazon Alexa For Shopping 10478388 | **3+ years** |
| JumpCloud Devices SWE | **3 to 5 years**, Go/OS |
| Goldman 177429 / 177428 / 168913 | Closed |
| PhonePe Android SDE | Wrong stack |
| PayPal SWE 2026 | New-grad / 2026 class |
| Shopify Backend Intern | Americas only |
| Google Uni Grad 2026 | New-grad |
| Swiggy careers | No open engineering jobs listed when checked |
| Meesho SDE | Open roles were SDE III |
| Razorpay Bengaluru eng | FDE (4+ YOE) or Malaysia SDE |
| CRED | No matching SDE-1 listing found on public careers |
