...
| # | Company | Role | Posted YOE | Resume PDF | Cover PDF | Apply |
|---|---------|------|------------|------------|-----------|-------|
| 1 | GitLab | Intermediate Backend Engineer | Intermediate (no 3+ floor) | `resumes/pdf/Atul_Banyal_Resume_GitLab_Backend.pdf` | `cover-letters/pdf/Atul_Banyal_Cover_GitLab_Backend.pdf` | [Job](https://job-boards.greenhouse.io/gitlab/jobs/8736877002) |
| 2 | GitLab | Intermediate Backend, Database Change Management | Intermediate (no 3+ floor) | `resumes/pdf/Atul_Banyal_Resume_GitLab_Database.pdf` | `cover-letters/pdf/Atul_Banyal_Cover_GitLab_Database.pdf` | [Job](https://job-boards.greenhouse.io/gitlab/jobs/8722304002) |
| 3 | Groww | SDE-I | SDE-I, no years listed | `resumes/pdf/Atul_Banyal_Resume_Groww.pdf` | `cover-letters/pdf/Atul_Banyal_Cover_Groww.pdf` | [Job](https://job-boards.eu.greenhouse.io/growwreferrals/jobs/4953090101) |
| 4 | Amazon | SDE I, FinOps FP&A | **1+ years** | `resumes/pdf/Atul_Banyal_Resume_Amazon_FinOps.pdf` | `cover-letters/pdf/Atul_Banyal_Cover_Amazon_FinOps.pdf` | [Job](https://www.amazon.jobs/en/jobs/10432823/software-development-engineer-i-finops-fp-a) |
| 5 | Accenture | Custom SWE, Node.js ATCI-R1-S1891558 | **2–5 years** | `resumes/pdf/Atul_Banyal_Resume_Accenture.pdf` | `cover-letters/pdf/Atul_Banyal_Cover_Accenture.pdf` | [Job](https://www.accenture.com/in-en/careers/jobdetails?id=ATCI-R1-S1891558_en) |
| 6 | JumpCloud | Full Stack SWE, Front-End Focus | **2 to 4 years** | `resumes/pdf/Atul_Banyal_Resume_JumpCloud_Fullstack.pdf` | `cover-letters/pdf/Atul_Banyal_Cover_JumpCloud_Fullstack.pdf` | [Job](https://jobs.lever.co/jumpcloud/4ebbdea9-39c2-465d-bbdf-bf379a8e4a06) |
